...
treat=c('Animal', 'Sewage', 'Sediment', 'Animal', 'Sediment', 'Sediment', 'Sediment', 'Sediment', 'Sediment', 'Sediment', 'Sediment', 'Animal')   # Manually entered groupings for the sample types, corresponds to the rownames of the file
...
graph <- ggplot() + 
  ...
  geom_point(data=abun.species.nmds.scores,aes(x=NMDS1,y=NMDS2),alpha=1, size=4) +  # add the species labels [if above 1% in any sample]
  ...
  labs(y = 'NMDS2', x = 'NMDS1', title = "Bray-curtis dissimilarity NMDS from k-SLAM results") + # change labels
